    ...
    <section id="hero">
      <div className="xl:pt-[49px] pt-10 xl:pb-[72px] pb-10 xl:px-[60px] px-4 flex md:flex-row flex-col items-center md:gap-[96px] gap-6">
        ...
        <div className="flex flex-col md:text-left sm:text-center text-left xl:space-y-0 space-y-2">
          ...
          {/* start trial button */}
          <div>
            <button className="xl:py-4 py-[10px] font-secondary transition-all delay-100 xl:px-7 px-4 xl:mt-9 mt-6 rounded-[49px] text-white text-sm font-light bg-secondary hover:bg-primary">
              START FREE TRIAL
            </button>
          </div>
        </div>
